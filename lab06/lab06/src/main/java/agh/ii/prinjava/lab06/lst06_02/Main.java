...
public class Main {
    ...
    /**
     * {@link UnaryOperator} - represents an operation on a single operand that produces a result of the same type as
    ...
    /**
     * {@link BinaryOperator} - represents an operation on two operands of the same type, producing a result of
